...
# Durable Devdocker Percona Server Entrypoint
...
apply_config() {
    ...
    log "Starting Percona Server temporarily for configuration updates"
...
main() {
    log "Durable Devdocker Percona Server starting"
    ...
    # Call original Percona Server entrypoint
